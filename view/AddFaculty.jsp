	  ...
	  <div class="collapse navbar-collapse" id="navbarCollapse">
		<ul class="navbar-nav mr-auto">
		  ...
		  <li class="nav-item">
			...
			<a class="nav-link" href="${url2 }">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fas fa-users"></i><br>Faculty</a>
		  </li>
		  <li class="nav-item">
...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-sm-2 col-md-2" style="text-align: center; font-size: 13px;">
					...
					<i class="fas fa-university fa-3x"></i><br/>
					</div>
					<div class="col-sm-10 col-md-10" style="margin-left: -6%;">
		...
		<div class="col-sm-2 col-md-2" style="text-align: center; font-size: 13px;">
					...
					<i class="fas fa-award fa-3x"></i><br/>
					</div>
					<div class="col-sm-10 col-md-10" style="margin-left: -6%;"> 
							<font size="4">Certification &nbsp;&nbsp; </font>
							<form:input type="radio" path="certification" name="gender" value="Yes"/> Yes &nbsp;&nbsp;
							<form:input type="radio" path="certification" name="gender" value="No"/> No</div>
