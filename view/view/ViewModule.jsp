	  ...
	  <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
		  ...
		  <li class="nav-item">
			...
			<a class="nav-link" href="${url3}">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fas fa-book"></i><br>Module</a>
		  </li>
		  <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		...
		<!--Content area-->
			...
			<div>	
	 		  <caption><h2>List of modules</h2></caption>
	 		  	  <table>
						<tr>
							<td><input id="myInput" type="text"
								placeholder="Search" onkeyup="myFunction()" class="form-control input-lg" style = "border-radius: 50px;"/>
							</td>
											
								<td><form>
									  <input type="radio" name="search" value="byName" checked>Search by Module Name&nbsp;&nbsp;
									  <input type="radio" name="search" value="byId">Search by Module Id<br>
					...
					<table>
					<tr>
					 <th onclick="w3.sortHTML('#myTable', '.item', 'td:nth-child(2)')" style="cursor:pointer" >Sort by Module Name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
					  <th onclick="w3.sortHTML('#myTable', '.item', 'td:nth-child(1)')" style="cursor:pointer">Sort by Module Id</th>
					</tr>  </table><br>
