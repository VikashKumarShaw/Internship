...
<ul class="navbar-nav mr-auto">
  <li class="nav-item ">
  <spring:url value="/home" var="url1" htmlEscape="true"/>
<a class="nav-link" href="${url1 }">Home <span class="sr-only">(current)</span></a>
  </li>
  <li class="nav-item">
...
<a class="nav-link" href="${url3}">Module</a>
  ...
  <li class="nav-item dropdown">
        ...
        <spring:url value="/BatchAllocation" var="url4" htmlEscape="true"/>
            <a class="dropdown-item" href="${url4}">Batch Allocation</a>
          <div class="dropdown-divider"></div>
          <spring:url value="/BatchUpdatation" var="url5" htmlEscape="true"/>
            <a class="dropdown-item" href="${url5}">Batch Update</a>
        </div>
      </li>
   <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
         <spring:url value="/Report" var="url6" htmlEscape="true"/>
            <a class="dropdown-item" href="${url6}">Report Generation</a>
          <div class="dropdown-divider"></div>
          <spring:url value="/ViewReport" var="url7" htmlEscape="true"/>
            <a class="dropdown-item" href="${url7}">View</a>
        </div>
      </li>
</ul>
...
<spring:url value="/BatchAllocation" var="url4" htmlEscape="true"/>
<a href="${url4}" class="btn btn-primary btn-sm color-b">Allocate</a>
<spring:url value="/BatchUpdation" var="url5" htmlEscape="true"/>
<a href="${url5}" class="btn btn-primary btn-sm color-b">Update</a>
  </div>
</div>
</div>
<div class="col-sm-6">
...
<spring:url value="/Report" var="url6" htmlEscape="true"/>
<a href="${url6}" class="btn btn-primary btn-sm color-b">Generate</a>
<spring:url value="/ViewReport" var="url7" htmlEscape="true"/>
<a href="${url7}" class="btn btn-primary btn-sm color-b">View</a>
  </div>
</div>
</div>
</div>
