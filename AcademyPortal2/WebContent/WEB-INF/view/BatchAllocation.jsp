...
<body>
	...
	<div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
        	<spring:url value="/BatchAllocation" var="url5" htmlEscape="true"/>
            <a class="dropdown-item" href="${url5}">Batch Allocation</a>
          <div class="dropdown-divider"></div>
          	<spring:url value="/BatchUpdatation" var="url6" htmlEscape="true"/>
            <a class="dropdown-item" href="${url6}">Batch Update</a>
        </div>
      </li>
		   <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
        <spring:url value="/Report" var="url7" htmlEscape="true"/>
            <a class="dropdown-item" href="${url7}">Report Generation</a>
          <div class="dropdown-divider"></div>
          <spring:url value="/ViewReport" var="url8" htmlEscape="true"/>
            <a class="dropdown-item" href="${url8}">View</a>
        </div>
      </li>
		</ul>
