...
<html lang="en">
  ...
  <body>
      ...
      <spring:url value="/home" var="url1" htmlEscape="true"/>
         <a class="navbar-brand" href="${url1}">Academy Portal</a>
       ...
       <div class="row">
              ...
              <div class="row">
                           ...
                           <div class="card-body" style="background-color:#f5f5f5;">
                                  ...
                                  <form:form role="form" action="module1" commandName="module" method="POST" onsubmit="showAlert()">
										...
										function showAlert(){
										alert("Module Details added Successfully");
										}
										</script>
