...
<html lang="en">
  ...
  <body>
    ...
    <spring:url value="/#" var="url1" htmlEscape="true"/>
...
<div class="container">
	...
	<div class="row">
		<div class="col-md-4">
			<div class="card" style="width: 18rem;">
			  ...
			  <ul class="list-group list-group-flush">
				<li class="list-group-item">Academy Address</li>
		...
		<form:input type="number" path="contact" id="AsID" class="form-control input-lg" placeholder="Contact Number" tabindex="1" pattern="(?=.*\d).{10}" required="required" value = "Contact Number"/><br/>
