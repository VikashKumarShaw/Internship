...
<html lang="en">
  ...
  <body>
	  ...
	  <a class="navbar-brand" href="${pageContext.request.contextPath}/home">Academy Portal</a>
	  ...
	  <div class="collapse navbar-collapse" id="navbarCollapse">
		...
		<form:form class="form-inline mt-2 mt-md-0" action="logOption"
			commandName="login" role="form" method="GET" onclick="logout()">
		...
		<div class="row">
				<div class="col-xs-12 col-sm-10 col-md-10 col-sm-offset-2 col-md-offset-3">
						...
						<div class="form-group">
							...
							<form:select path="qualification" name="qualification" id="qualification" class="browser-default custom-select" placeholder="Qualification" tabindex="3" required="required">  
        						<option value="" disabled selected style="display: none;">Qualification</option>
        					...
        					<br>
							<font size="4">Certification </font>
